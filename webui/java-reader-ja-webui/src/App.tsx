...
function App() {
  ...
  const [initJdtlsPath, setInitJdtlsPath] = useState<string>("");
  const [initJavaProjectPath, setInitJavaProjectPath] = useState<string>("");
  ...
  useEvent("message", (event: MessageEvent) => {
    ...
    switch (type) {
      ...
      case "state":
        ...
        break;
      case "init":
        setInitJdtlsPath(parsedMessage.jdtls);
        setInitJavaProjectPath(parsedMessage.javaProjectPath);
        ...
        if (!parsedMessage.jdtls || !parsedMessage.javaProjectPath) {
  ...
  return (
    <div style={{height: "90vh"}}>
      ...
      <SettingView
        ...
        initJdtlsPath ={initJdtlsPath}
        initJavaProjectPath={initJavaProjectPath}
